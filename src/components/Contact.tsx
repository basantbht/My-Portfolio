...
const Contact = () => {
  ...
  return (
    ...
    id="contact" className="py-20 container max-w-6xl mx-auto px-4 scroll-my-5">
      <motion.h1 
      initial={{opacity: 0}}
    whileInView={{opacity: 1}}
    transition={{delay: 0.3, duration: 0.5}}
      className="text-4xl font-bold text-center mb-12">Contact <span className="text-primary">Me</span></motion.h1>
    ...
    transition={{delay: 1.3, duration: 0.6}}
            ...
            transition={{ duration: 0.3}}
              type="submit"
              className="w-full bg-primary text-white py-3 rounded-lg font-semibold hover:bg-primary/90 transition shadow-md"
            >
              Send Message
            </motion.button>
